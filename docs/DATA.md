...
- **매핑·카피·구절 전부 자체.** 코드↔인물 매핑은 보편 연상 기반 자체 편집, 인물 설명·소명·기도는 직접 작성, 구절은 공개도메인(KJV) 인용. (외부 자료 비의존 — 아래 §신학적 정확성)
...
- 매핑·readingRef·카피 전부 자체(보편 연상 + 오리지널). 인물 해석은 성경 본문 근거. 타입·파일 규칙은 위 고정.
